...
echo -e "${NC}"
zelnodeprivkey="$(whiptail --title "ZelNode ANALIZER/FiXER v2.8" --inputbox "Enter your zelnode Private Key generated by your Zelcore/Zelmate wallet" 8 72 3>&1 1>&2 2>&3)"
zelnodeoutpoint="$(whiptail --title "ZelNode ANALIZER/FiXER v2.8" --inputbox "Enter your zelnode Output TX ID" 8 72 3>&1 1>&2 2>&3)"
zelnodeindex="$(whiptail --title "ZelNode ANALIZER/FiXER v2.8" --inputbox "Enter your zelnode Output Index" 8 60 3>&1 1>&2 2>&3)"
echo -e "${YELLOW}=====================================================${NC}"
