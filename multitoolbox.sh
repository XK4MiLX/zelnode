...
pm2 start ~/watchdog/watchdog.js --name watchdog --watch /home/$USER/watchdog --ignore-watch node_modules --watch-delay 15
pm2 save
fi
...
echo -e "${GREEN}OS: Ubuntu 16/18, Debian 9${NC}"
