...
echo -e "${YELLOW}====================================================================="
echo -e " Zelnode & Zelflux Install - XK4MiLX Final Edition (06.04.2020)"
echo -e "=====================================================================${NC}"
echo -e "${CYAN}MAR 2020, created by dk808 improved by XK4MiLX from Zel's team and AltTank Army."
